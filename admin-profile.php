...
$sql = "SELECT * FROM admin_login WHERE admin_login.id = '".$id."'";
...
$admin_row = mysqli_fetch_assoc($query);
                  ...
                  <img class="profile-user-img img-fluid img-circle"
                       src="assets/images/admin/<?php echo $admin_row['picture']; ?>"
                       alt="User profile picture">

                </div>

                <h3 class="profile-username text-center"><?php echo $admin_row['fullName']; ?></h3>
