...
<?php 
    $sql = "SELECT address.tel FROM address";
 ...
 <?php 
    if (isset($_POST['update'])) {
      ...
      $sql = "UPDATE address SET tel = '".$tel."'";
      $query = mysqli_query($conn, $sql) or die(mysqli_error($conn));

      $_SESSION['message'] = "Mobile number has been updated!";
      ...
      <div class="row">
        ...
        <div class="col-8">
            <div class="form-group">
                    	<h3 style="color: red; font-weight: bold; font-family: gabriola">Company Telephone number</h3>
                </div>
          <div class="card">
            <!-- /.card-header -->
            <div class="card-body">
		        ...
		        ?>
           <a href="telephone.php" style="color: blue">Refresh</a>
		            </div>
				...
				<p style="font-size: 20px; font-weight: bold;"><?php echo $row['tel']; ?></p>
                </div>

      <form class="form" method="POST">
        <div class="form-group">
          <label style="font-size: 20px">Kindly enter the new Telephone numbers below:</label>
        </div>

        <div class="form-group">
          <label style="font-size: 20px">Offie Number</label>
          <input type="mobile" name="tel"; required="tel" class="form-control">
        </div>
