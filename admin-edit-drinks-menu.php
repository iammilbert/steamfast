...
$sql = "SELECT * FROM drinks_menu WHERE id='".$id."'";

$query = mysqli_query($conn, $sql) or die(mysqli_error($conn));

$drinks_row = mysqli_fetch_assoc($query);
      ...
      <div class="row">
        ...
        <div class="col-8">
          ...
          <div class="card">
            ...
            ?>
            <a href="admin-drinks-menu.php" style="color: blue">Refresh</a>
                </div>
            ...
            <?php endif ?>
             ...
             <form method = "POST" action="<?php echo $_SERVER['PHP_SELF']; ?>" enctype="multipart/form-data">
               ...
               <div class="form-group">
                    <input type="hidden" id="id" name="id" value="<?php echo $drinks_row['id']; ?>">
                </div>
                 ...
                 <div class="form-group">
                        ...
                        <input class="form-control" type="text" name="food_name" placeholder="Food Name" value="<?php echo $drinks_row['food_name']; ?>">
                </div>

                 <div class="form-group">
                        <label for="price">Price</label>

                        <input type="text" class="form-control" name="price" placeholder="Price" value="<?php echo $drinks_row['price']; ?>">
                </div>
