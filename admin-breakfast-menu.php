...
<?php
                                ...
                                if(isset($_GET['delete'])){
                                    ...
                                    $sql = "DELETE FROM breakfast_menu WHERE id='".$id."'";

                                    $query = mysqli_query($conn, $sql) or die(mysqli_error($conn));
                                }


                                $sql = "SELECT * FROM breakfast_menu";
    ...
    <?php while($breakfast_row = mysqli_fetch_assoc($query)): ?>
            <div class="col-12 col-sm-6 col-md-4">
              <div class="card bg-light">                
            <img alt="img" src="assets/images/food/breakfast/<?php echo $breakfast_row['picture']; ?>">
                 <div style="text-align: center; font-family: gabriola">
                        <h3><?php echo $breakfast_row['food_name']; ?> </h3>

                         <h3><?php echo $breakfast_row['price']; ?></h3>
                  </div> 

                <div class="card-footer">
                  <div class="text-center">
                    <a href="admin-breakfast-menu.php?delete=<?php echo $breakfast_row['id']; ?>" class="btn btn-danger">
                      <i class="fas fa-trash"></i>
                    </a>
                    <a href="admin-edit-menu.php?id=<?php echo $breakfast_row['id'] ?>" class="btn btn-success">
