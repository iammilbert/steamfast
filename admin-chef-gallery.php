...
?>
    ...
    <?php while($staff_row = mysqli_fetch_assoc($query)): ?>
            ...
            <img src="assets/images/staff/<?php echo $staff_row['picture']; ?>">
                 <div style="text-align: center; font-family: gabriola">
                        <h5><b>First Name:</b> <?php echo $staff_row['firstName']; ?> </h5>

                        <h5><b>Last Name:</b> <?php echo $staff_row['lastName']; ?></h5>
                        <h5><b>Middle Name:</b> <?php echo $staff_row['middleName']; ?></h5>
                        <h5><b>Position:</b> <?php echo $staff_row['position']; ?></h5>
                  </div> 

                <div class="card-footer">
                  <div class="text-center">
                    <a href="admin-chef-gallery.php?delete=<?php echo $staff_row['id']; ?>" class="btn btn-danger">
                      <i class="fas fa-trash"></i>
                    </a>
                    <a href="admin-edit-chef.php?id=<?php echo $staff_row['id'] ?>" class="btn btn-success">
