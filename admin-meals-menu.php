...
<?php
                                ...
                                if(isset($_GET['delete'])){
                                    ...
                                    $sql = "DELETE FROM meals_menu WHERE id='".$id."'";

                                    $query = mysqli_query($conn, $sql) or die(mysqli_error($conn));
                                }


                                $sql = "SELECT * FROM meals_menu";
    ...
    <?php while($meals_row = mysqli_fetch_assoc($query)): ?>
            <div class="col-12 col-sm-6 col-md-4">
              <div class="card bg-light">                
            <img alt="img" src="assets/images/food/meals/<?php echo $meals_row['picture']; ?>">
                 <div style="text-align: center; font-family: gabriola">
                        <h3><?php echo $meals_row['food_name']; ?> </h3>

                         <h3><?php echo $meals_row['price']; ?></h3>
                  </div> 

                <div class="card-footer">
                  <div class="text-center">
                    <a href="admin-meals-menu.php?delete=<?php echo $meals_row['id']; ?>" class="btn btn-danger">
                      <i class="fas fa-trash"></i>
                    </a>
                    <a href="admin-edit-meals-menu.php?id=<?php echo $meals_row['id'] ?>" class="btn btn-success">
