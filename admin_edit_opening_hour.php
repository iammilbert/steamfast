...
<!-- Main content -->
      ...
      <div class="row">
        ...
        <div class="col-8">
            <div class="form-group">
                    	<h3 style="color: red; font-weight: bold; font-family: gabriola">Company Opening/Closing Hour</h3>
                </div>
          <div class="card">
            <!-- /.card-header -->
            <div class="card-body">
    ...
    <form method="POST" class="form">
          <div class="form-group">
            <label>Monday</label>
            <input type="text" name="monday" class="form-control" value="<?php echo $row['monday']; ?>">
            
          </div>
          <div class="form-group">
            <label>Tuesday</label>
            <input type="text" name="tuesday" class="form-control" value="<?php echo $row['tuesday']; ?>">
            
          </div>
          <div class="form-group">
            <label>Wednesday</label>
            <input type="text" name="wednesday" class="form-control" value="<?php echo $row['wednesday']; ?>">
            
          </div>
          <div class="form-group">
            <label>Thursday</label>
            <input type="text" name="thursday" class="form-control" value="<?php echo $row['thursday']; ?>">
            
          </div>
          <div class="form-group">
            <label>Friday</label>
            <input type="text" name="friday" class="form-control" value="<?php echo $row['friday']; ?>">
            
          </div>
          <div class="form-group">
            <label>Saturday</label>
            <input type="text" name="saturday" class="form-control" value="<?php echo $row['saturday']; ?>">
            
          </div>

          <div class="form-group">
            <label>Sunday</label>
            <input type="text" name="sunday" class="form-control" value="<?php echo $row['sunday']; ?>">
          ...
          <div class="form-group">
            ...
            <a href="admin-dashboard.php" class="btn btn-danger">Dashboard</a>
