...
if($_SERVER['REQUEST_METHOD'] == 'POST'){
    ...
    $sql = "INSERT INTO breakfast_menu
            (
                food_name, 
                price, 
                picture
                ...
                <form method = "POST" action="<?php echo $_SERVER['PHP_SELF']; ?>" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                             <label for="food_name">Food Name<b style="color: red">*</b></label>
                              <input type="text" name="food_name" class="form-control" required="food_name">
                        </div>


                         <div class="form-group">
                             <label for="price">Price<b style="color: red">*</b></label>
                               <input type="text" name="price" class="form-control" required="price">
