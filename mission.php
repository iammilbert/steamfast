...
<?php 
		$sql = "SELECT about_us.mission FROM about_us";
 ...
 <?php 
 		if (isset($_POST['update'])) {
 			...
 			$sql = "UPDATE about_us SET mission = '".$mission."'";
 			$query = mysqli_query($conn, $sql) or die(mysqli_error($conn));
      ...
      <div class="row">
        ...
        <div class="col-8">
            <div class="form-group">
                    	<h3 style="color: red; font-weight: bold; font-family: gabriola">MISSION STATEMENT</h3>
                </div>
          <div class="card">
            <!-- /.card-header -->
            <div class="card-body">
		        ...
		        ?>
            <a href="mission.php" style="color: blue">Refresh</a>
		            </div>
				...
				<p style="font-size: 20px"><?php echo $row['mission']; ?></p>
                </div>

             <form class="form" method="POST">
				<div class="form-group">
					<label style="font-size: 20px">Kindly enter the new text below; avoid using appostrophy.</label>
					<textarea class="form-control" style="font-size: 27px;" rows="5" name="mission"></textarea>
				</div>
