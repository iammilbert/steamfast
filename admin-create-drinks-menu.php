...
if($_SERVER['REQUEST_METHOD'] == 'POST'){
    ...
    if($query)
    {
        move_uploaded_file($pic_tmp_name, "assets/images/food/drinks/$pic_name");

        $_SESSION['message'] = "Menu successfully added";
          ...
          <div class="card">
            ...
            <div class="card-body">
                ...
                <form method = "POST" action="<?php echo $_SERVER['PHP_SELF']; ?>" enctype="multipart/form-data">
                          ...
                          <div class="form-group">
                             <label for="food_name">Food Name<b style="color: red">*</b></label>
                              <input type="text" id="food_name" name="food_name" placeholder="Food Name" class="form-control" required="food_name">
                        </div>


                         <div class="form-group">
                             <label for="price">Price<b style="color: red">*</b></label>
                               <input type="text" id="price" name="price" placeholder="Price" class="form-control" required="price">
