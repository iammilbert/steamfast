...
<?php include('db_connect.php'); ?>
 ...
 <?php 
		$sql = "SELECT about_us.vision FROM about_us";
      ...
      <div class="row">
        ...
        <div class="col-8">
            <div class="form-group">
                    	<h3 style="color: red; font-weight: bold; font-family: gabriola">VISION STATEMENT</h3>
                </div>
          <div class="card">
            <!-- /.card-header -->
            <div class="card-body">
		        ...
		        ?>
            <a href="vision.php" style="color: blue">Refresh</a>
		            </div>
				...
				<p style="font-size: 20px"><?php echo $row['vision']; ?></p>
                </div>

             <form class="form" method="POST">
				<div class="form-group">
					<label style="font-size: 20px">Kindly enter the new text below; avoid using appostrophy.</label>
					<textarea class="form-control" style="font-size: 27px;" rows="5" name="vision"></textarea>
				</div>
