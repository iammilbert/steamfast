...
if($_SERVER['REQUEST_METHOD'] == 'POST'){
    ...
    if($query)
    {
        move_uploaded_file($pic_tmp_name, "assets/images/admin/$pic_name");
      ...
      <div class="row">
        ...
        <div class="col-8">
          ...
          <div class="card">
            ...
            ?>
            <a href="admin-profile.php" style="color: blue">Refresh</a>
                </div>
            ...
            <?php endif ?>
             ...
             <form method = "POST" action="<?php echo $_SERVER['PHP_SELF']; ?>" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <input type="hidden" id="id" name="id" value="<?php echo $admin_row['id']; ?>">
                </div>
                ...
                <div class="form-group">
                        <input type="submit" name="submit" value="Upload" class="btn btn-lg btn-primary">
                        <a href="admin-gallery.php" class="btn btn-lg btn-danger"><i class="fa fa-user"> Profile</i></a>
                </div>               
