...
<?php 
    $sql = "SELECT address.office_Address FROM address";
 ...
 <?php 
    if (isset($_POST['update'])) {
      ...
      $sql = "UPDATE address SET office_Address = '".$office_Address."'";
      $query = mysqli_query($conn, $sql) or die(mysqli_error($conn));

      $_SESSION['message'] = "Office Address has been updated Successfully!";
      ...
      <div class="row">
        ...
        <div class="col-8">
            <div class="form-group">
                    	<h3 style="color: red; font-weight: bold; font-family: gabriola">Company Address</h3>
                </div>
          <div class="card">
            <!-- /.card-header -->
            <div class="card-body">
		        ...
		        ?>
           <a href="office_address.php" style="color: blue">Refresh</a>
		            </div>
				...
				<p style="font-size: 20px"><?php echo $row['office_Address']; ?></p>
                </div>

             <form class="form" method="POST">
				<div class="form-group">
					<label style="font-size: 20px">Kindly enter the new office adrress below:</label>
          <textarea class="form-control" style="font-size: 27px;" name="office_Address"></textarea>
				</div>
