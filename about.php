...
<?php 
		$sql = "SELECT about_us.about FROM about_us";
 ...
 <?php 
 		if (isset($_POST['update'])) {
            ...
            $_SESSION['msg_type'] = "success";
 				...
 				$_SESSION['message'] = "Please check spellings and avoid using appostrophy!";
            $_SESSION['msg_type'] = "success";
 			}
      ...
      <div class="row">
        ...
        <div class="col-8">
            <div class="form-group">
                    	<h3 style="color: red; font-weight: bold; font-family: gabriola">ABOUT US</h3>
                </div>
          <div class="card">
            <!-- /.card-header -->
            <div class="card-body">
		        ...
		        ?>
            <a href="about.php" style="color: blue">Refresh</a>
		            </div>
				...
				<p style="font-size: 20px"><?php echo $row['about']; ?></p>
                </div>

             <form class="form" method="POST">
				<div class="form-group">
					<label style="font-size: 20px">Kindly enter the new text below; avoid using appostrophy.</label>
					<textarea class="form-control" style="font-size: 27px;" rows="5" name="about"></textarea>
				</div>

				<div class="form-group">
					<input type="submit" name="update" class="btn btn-primary" value="Submit">
					<a class="btn btn-danger" href="admin-dashboard.php">Cancel</a>
				</div>
			</form>
