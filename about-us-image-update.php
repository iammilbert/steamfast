...
if($_SERVER['REQUEST_METHOD'] == 'POST'){
    ...
    if($query)
    {
        move_uploaded_file($pic_tmp_name, "assets/images/about-us/$pic_name");
            $_SESSION['message'] = "Record has been updated!";
            $_SESSION['msg_type'] = "success";
            }
            else{
                $_SESSION['message'] = "Sorry error occured. please re-upload!";
      ...
      <div class="row">
        ...
        <div class="col-8">
            <div class="form-group">
                    <h1>Editing About-us Picture</h1>
                </div>
          <div class="card">
            <!-- /.card-header -->
            <div class="card-body">
            ...
            ?>
            <a href="about-us-image.php" style="color: blue">Refresh</a>
                </div>
            ...
            <?php endif ?>
             ...
             <form method = "POST" action="<?php echo $_SERVER['PHP_SELF']; ?>" enctype="multipart/form-data">
                ...
                <div class="form-group">
                        ...
                        <a href="about-us-image.php" class="btn btn-danger">Cancel</i></a>
                </div>               
