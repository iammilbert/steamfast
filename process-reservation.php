...
$reserved_row = mysqli_fetch_assoc($query);
...
if ($query) {
  # code...
      ...
      header('location: pages/tables/ready_reservation.php');
      ...
      <div class="row">
        ...
        <div class="col-8">
          <div class="form-group">
            <h3>Processing <span style="color: orange"><?php echo $reserved_row['fullName']; ?></span>  Reservation</h3>
...
<input type="text" name="reserved_id" value="<?php echo $_GET['id']; ?>">
                        <input type="text" class="form-control" name="email" value="<?php echo $reserved_row['email']; ?>">
                </div>
                 
               <div class="form-group">
                 <select class="form-control" name="status">
                   <option value="1">Process</option>
                   <option class="3">Invalid</option>
                 </select>
               </div>
                ...
                <div class="form-group">
                        <input type="submit" name="update" value="Process" class="btn btn-flat btn-primary">

                        <a href="ready_reservation.php" class="btn btn-flat btn-danger">Cancel</a>
                </div>               
