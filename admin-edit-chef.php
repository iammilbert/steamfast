...
if($_SERVER['REQUEST_METHOD'] == 'POST'){
    ...
    if($query)
    {
        move_uploaded_file($pic_tmp_name, "assets/images/staff/$pic_name");
      ...
      <div class="row">
        ...
        <div class="col-8">
          ...
          <div class="card">
            ...
            ?>
            <a href="admin-chef-gallery.php" style="color: blue">Refresh</a>
                </div>
            ...
            <?php endif ?>
             ...
             <form class="mu-reservation-form" method = "POST" action="<?php echo $_SERVER['PHP_SELF']; ?>" enctype="multipart/form-data">

                 <div class="form-group">
                    <input type="hidden" id="id" name="id" value="<?php echo $staff_row['id']; ?>">
                </div>

                        <div class="form-group">
                             <label for="firstName">First Name<b style="color: red">*</b></label>
                              <input type="text" id="firstName" name="firstName" placeholder="First Name" class="form-control" required="firstName" value="<?php echo $staff_row['firstName']; ?>">
                        </div>


                         <div class="form-group">
                             <label for="lastName">Last Name<b style="color: red">*</b></label>
                               <input type="text" id="lastName" name="lastName" placeholder="last Name" class="form-control" required="lastName" value="<?php echo $staff_row['lastName']; ?>">

                        </div>

                         <div class="form-group">
                             <label for="middleName">Middle Name<b style="color: red">*</b></label>
                               <input type="text" id="middleName" name="middleName" placeholder="middle Name" class="form-control" required="middleName" value="<?php echo $staff_row['middleName']; ?>">

                        </div>

                          <div class="form-group">
                             <label for="position">Position<b style="color: red">*</b></label>
                               <input type="text" id="position" name="position" placeholder="Position" class="form-control" required="position" value="<?php echo $staff_row['position']; ?>">
                        ...
                        <div class="form-group">
                             <input type="submit" name="submit" value="Submit" class="btn btn-lg btn-block" style="background-color: green; color: white">
