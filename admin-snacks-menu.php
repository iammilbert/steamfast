...
<?php
                                ...
                                if(isset($_GET['delete'])){
                                    ...
                                    $sql = "DELETE FROM snacks_menu WHERE id='".$id."'";

                                    $query = mysqli_query($conn, $sql) or die(mysqli_error($conn));
                                }


                                $sql = "SELECT * FROM snacks_menu";
    ...
    <?php while($snacks_row = mysqli_fetch_assoc($query)): ?>
            <div class="col-12 col-sm-6 col-md-4">
              <div class="card bg-light">                
            <img alt="img" src="assets/images/food/snacks/<?php echo $snacks_row['picture']; ?>">
                 <div style="text-align: center; font-family: gabriola">
                        <h3><?php echo $snacks_row['food_name']; ?> </h3>

                         <h3><?php echo $snacks_row['price']; ?></h3>
                  </div> 

                <div class="card-footer">
                  <div class="text-center">
                    <a href="admin-snacks-menu.php?delete=<?php echo $snacks_row['id']; ?>" class="btn btn-danger">
                      <i class="fas fa-trash"></i>
                    </a>
                    <a href="admin-edit-snacks-menu.php?id=<?php echo $snacks_row['id'] ?>" class="btn btn-success">
