...
$sql = "SELECT * FROM breakfast_menu WHERE id='".$id."'";
...
if($_SERVER['REQUEST_METHOD'] == 'POST'){
   ...
   if($query)
    {
        move_uploaded_file($pic_tmp_name, "assets/images/food/breakfast/$pic_name");
      ...
      <div class="row">
        ...
        <div class="col-8">
          ...
          <div class="card">
            ...
            ?>
            <a href="admin-breakfast-menu.php" style="color: blue">Refresh</a>
                </div>
             ...
             <form method = "POST" action="<?php echo $_SERVER['PHP_SELF']; ?>" enctype="multipart/form-data">
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                        ...
                        <input class="form-control" type="text" name="food_name" placeholder="Food Name" value="<?php echo $staff_row['food_name']; ?>">
                </div>

                 <div class="form-group">
                        <label for="price">Price</label>

                        <input type="text" class="form-control" name="price" placeholder="Price" value="<?php echo $staff_row['price']; ?>">
                </div>
                ...
                <div class="form-group">
                        ...
                        <a class="btn btn-danger" href="admin-breakfast-menu.php" class="btn btn-success">Cancel</a>
                    </a>
                </div>                
