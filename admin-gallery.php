              ...
              <img alt="img" src="assets/images/gallery/<?php echo $gallery_row['picture']; ?>">                
                <div class="card-footer">
                  <div class="text-center">
                    <a href="admin-gallery.php?delete=<?php echo $gallery_row['id']; ?>" class="btn btn-danger">
                      <i class="fas fa-trash"></i>
                    </a>
                    <a href="admin-edit-gallery.php?id=<?php echo $gallery_row['id'] ?>" class="btn btn-success">
