...
<?php 
    $sql = "SELECT address.email FROM address";
 ...
 <?php 
    if (isset($_POST['update'])) {
      ...
      $sql = "UPDATE address SET email = '".$email."'";
      $query = mysqli_query($conn, $sql) or die(mysqli_error($conn));

      $_SESSION['message'] = "Office Email has been updated Successfully!";
      ...
      <div class="row">
        ...
        <div class="col-8">
            <div class="form-group">
                    	<h3 style="color: red; font-weight: bold; font-family: gabriola">Company Email</h3>
                </div>
          <div class="card">
            <!-- /.card-header -->
            <div class="card-body">
		        ...
		        ?>
            <a href="email.php" style="color: blue">Refresh</a>
		            </div>
				...
				<p style="font-size: 20px"><?php echo $row['email']; ?>
                </div>

             <form class="form" method="POST">
				<div class="form-group">
					<label style="font-size: 20px">Kindly enter the new text below</label>
					<textarea class="form-control" style="font-size: 27px;" name="email"></textarea>
				</div>
