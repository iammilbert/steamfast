...
<?php
    ...
    <?php while($drinks_row = mysqli_fetch_assoc($query)): ?>
            <div class="col-12 col-sm-6 col-md-4">
              <div class="card bg-light">                
            <img alt="img" src="assets/images/food/drinks/<?php echo $drinks_row['picture']; ?>">
                 <div style="text-align: center; font-family: gabriola">
                        <h3><?php echo $drinks_row['food_name']; ?> </h3>

                         <h3><?php echo $drinks_row['price']; ?></h3>
                  </div> 

                <div class="card-footer">
                  <div class="text-center">
                    <a href="admin-drinks-menu.php?delete=<?php echo $drinks_row['id']; ?>" class="btn btn-danger">
                      <i class="fas fa-trash"></i>
                    </a>
                    <a href="admin-edit-drinks-menu.php?id=<?php echo $drinks_row['id'] ?>" class="btn btn-success">
